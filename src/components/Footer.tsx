  ...
  return (
    <footer className="relative border-t border-white/8 pb-10 pt-16">
      <div className="site-shell">
        <p className="max-w-3xl font-serif text-4xl leading-[1.08] text-stone sm:text-5xl">
          Let&apos;s build something{" "}
          <em className="italic text-brass">you keep</em>.
        </p>
        ...
        <div className="mt-12 grid gap-10 border-t border-white/8 pt-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <p className="font-mono text-[0.65rem] tracking-[0.18em] text-brass uppercase">
              Navigate
            </p>
          ...
          <div>
            ...
            <a
              ...
              className="mt-4 block text-sm text-muted hover:text-brass"
            >
              {site.email}
            </a>
        ...
        <div className="mt-12 flex flex-col gap-2 border-t border-white/8 pt-6 font-mono text-[0.65rem] tracking-[0.14em] text-muted uppercase sm:flex-row sm:justify-between">
          ...
          <p>Built for operators, not lock-in</p>
        </div>
      </div>
    </footer>
  );
